...
Options: die, eat, give, sleep  
Answer: *die*  

```{r, message = FALSE, echo = FALSE}
#write.csv(corpus, "./inTrain.csv")
head(trigramMatrixFreq[grep("^live and ", trigramMatrixFreq[,1]),], 10)
```

2. Guy at my table's wife got up to go to the bathroom and I asked about dessert and he started telling me about his  
Options: horticultural, spiritual, financial, marital  
Answer: *is not spiritual*  

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^about his ", trigramMatrixFreq[,1]),], 50)

# didn´t find it into top10. So try to look every options
rbind(trigramMatrixFreq[grep("^about his horticultural", trigramMatrixFreq[,1]),], 
      trigramMatrixFreq[grep("^about his spiritual", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^about his financial", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^about his marital", trigramMatrixFreq[,1]),])
```

3. I'd give anything to see arctic monkeys this  
Options: decade, weekend, morning, month 
Answer: *weekend* manual  

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^monkey this ", trigramMatrixFreq[,1]),], 10)

# didn´t find it into top10. So try to look every options
rbind(trigramMatrixFreq[grep("^monkeys this decade", trigramMatrixFreq[,1]),], 
      trigramMatrixFreq[grep("^monkeys this weekend", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^monkeys this morning", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^monkeys this month", trigramMatrixFreq[,1]),])
```


4. Talking to your mom has the same effect as a hug and helps reduce your  
Options: stress, happiness, hunger, sleepiness  
Answer: *stress*   
```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^reduce your ", trigramMatrixFreq[,1]),], 10)

# didn´t find it into top10. So try to look every options
rbind(trigramMatrixFreq[grep("^reduce your stress", trigramMatrixFreq[,1]),], 
      trigramMatrixFreq[grep("^reduce your happiness", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^reduce your hunger", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^reduce your sleepiness", trigramMatrixFreq[,1]),])
```

5. When you were in Holland you were like 1 inch away from me but you hadn't time to take a  
Options: walk, picture, look, minute  
Answer: *picture*  

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^to take ", trigramMatrixFreq[,1]),], 10)

# didn´t find it into top10. So try to look every options
rbind(trigramMatrixFreq[grep("^to take walk", trigramMatrixFreq[,1]),], 
      trigramMatrixFreq[grep("^to take picture", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^to take look", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^to take minute", trigramMatrixFreq[,1]),])
```

6. I'd just like all of these questions answered, a presentation of evidence, and a jury to settle the  
Options: case, incident, account, matter  
Answer: *matter*   

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^settle the ", trigramMatrixFreq[,1]),], 10)

# didn´t find it into top10. So try to look every options
rbind(trigramMatrixFreq[grep("^settle the case", trigramMatrixFreq[,1]),], 
      trigramMatrixFreq[grep("^settle the incident", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^settle the account", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^settle the matter", trigramMatrixFreq[,1]),])
```

7. I can't deal with unsymetrical things. I can't even hold an uneven number of bags of groceries in each  
Options: toe, finger, arm, hand  
Answer: *hand*  

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^in each ", trigramMatrixFreq[,1]),], 10)
```

8. AEvery inch of you is perfect from the bottom to the  
Options: side, middle, center, top  
Answer: *top*   

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^to the ", trigramMatrixFreq[,1]),], 10)
```

9. I’m thankful my childhood was filled with imagination and bruises from playing  
Options: daily, weekly, outside, inside  
Answer: *outside*  

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^from playing ", trigramMatrixFreq[,1]),], 20)

# didn´t find it into top10. So try to look every options
rbind(trigramMatrixFreq[grep("^from playing daily", trigramMatrixFreq[,1]),], 
      trigramMatrixFreq[grep("^from playing weekly", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^from playing outside", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^from playing inside", trigramMatrixFreq[,1]),])
```

10. I like how the same people are in almost all of Adam Sandler's  
Options: novels, pictures, stories, movies  
Answer: *movies*  

```{r, message = FALSE, echo = FALSE}
head(trigramMatrixFreq[grep("^adam sandler ", trigramMatrixFreq[,1]),], 10)

# didn´t find it into top10. So try to look every options
rbind(trigramMatrixFreq[grep("^adam sandler novels", trigramMatrixFreq[,1]),], 
      trigramMatrixFreq[grep("^adam sandler pictures", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^adam sandler stories", trigramMatrixFreq[,1]),],
      trigramMatrixFreq[grep("^adam sandler movies", trigramMatrixFreq[,1]),])
```
